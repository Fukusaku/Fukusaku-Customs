...
<head>
	...
	<script type="text/javascript">
		...
		function slide()
		{				
			var plik = "<img src=\"img/interceptor" + number + ".jpg\" width=580px height=400px/>";
...
<?php
	for ($i=1; $i<5; $i++)
	{
		if (is_file('img/interceptor'.$i.'.jpg'))
			echo '<div id="mini'.$i.'" onclick="setslide('.$i.')" style="cursor:pointer;"><img src="img/interceptor'.$i.'.jpg" width=80px height=50px/></div>';	
...
?>
		...
		<div class="east">
			...
			<section>
				...
				<h1>TIE Interceptor minifig scale</h1>
				<br>
				...
				<div class="product-des">
					...
					<p class="p2"><strong><iframe width="360" height="220" src="https://www.youtube.com/embed/CfQdET6A6_g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></strong></p>
					<p class="p2"><strong>Instructions Only!</strong></p>
					<p class="p1">Highly detailed and shape-acurate TIE Interceptor MOC based on models seen in the Star Wars movies.</p>
					...
					<ul>
					<li>
					<span>BrickLink Price:</span><span> </span>~$200 - $250 USD</li>
					<li>
					<span>Part Count:</span><span> 1055 </span>pieces</li>
					<li>
					<span>Dimensions:</span><span> </span>Length 30 cm, width 25 cm, height 29 cm</li>
					</ul>
